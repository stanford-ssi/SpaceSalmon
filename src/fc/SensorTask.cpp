...
#ifdef MS5611
        data.ms1_data = sys.sensors.pres1.readSensor();
#else
...
#ifdef MS5611
        data.ms2_data = sys.sensors.pres2.readSensor();
#else
        data.bmp2_data = sys.sensors.pres2.readSensor();
#endif // vTaskDelay(2); //but why...
...
#ifdef MS5611
        JsonObject ms1_json = sensor_json.createNestedObject("ms1");
        ms1_json["p"] = data.ms1_data.pressure;
        ms1_json["t"] = data.ms1_data.temperature;
#else
...
#ifdef MS5611
        JsonObject ms2_json = sensor_json.createNestedObject("ms2");
        ms2_json["p"] = data.ms2_data.pressure;
        ms2_json["t"] = data.ms2_data.temperature;
#else
