...
*
*******************************************************************************/
Squib_ReturnType Squib::ProgramCmd(Squib_ProgCmdType Command, uint8_t Data, uint8_t Delay, uint8_t *SpiResponse)
{
  Squib_ReturnType ret_val;
  Ard_ComReturnType ret_com;
...
Squib_ReturnType Squib::fire(Squib_FireType Squib_Fire)
{
  Squib_ReturnType ret_val;
  Ard_ComReturnType ret_com;
...
Squib_ReturnType Squib::GetStatus(Squib_StatusType *Status)
{
  Squib_ReturnType ret_val;
  Ard_ComReturnType ret_com;
