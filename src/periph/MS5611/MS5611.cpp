...
//  0.1.ssi.1 2022-05-17 added convenience methods for SpaceSalmon framework
...
// PUBLIC
//
MS5611_SPI::MS5611_SPI(uint8_t select, uint8_t dataOut, uint8_t dataIn, uint8_t clock) : Sensor(id)
{
...
MS5611_SPI::MS5611_SPI(SPIClass *spi, int8_t cspin, const char* id) : Sensor(id)
{
  // _address           = deviceAddress;  // TODO
  _samplingRate      = OSR_ULTRA_LOW;
  _temperature       = MS5611_NOT_READ;
