...
LoadSensor::LoadSensor(std::string ch_name, Ad7124::InputSel ainp, Ad7124::InputSel ainm) : Sensor(ch_name, ainp, ainm) {
    sys.adc.setChannel(channel, cfg, ainp, ainm, true);
