...
cf = bitstruct.CompiledFormatDict(">b1 b1 b1 b1 b1 b1 b1 b1 u15 u18 u18 b1 u11 u15 b1 u3 u8 u8 u18 p4 >", [
                                  "pyroD_fired", "pyroC_fired","pyroB_fired", "pyroA_fired","pyroD","pyroC","pyroB","pyroA","gps_alt", "lon", "lat", "gps_lock", "filter_vel", "filter_alt", "armed", "state", "batt_cots", "batt_srad", "time"])
...
def decodeTelem(data, pos):
    ...
    data["batt_srad"] = expand_float(data["batt_srad"], 1.0, 6.0, 8)
